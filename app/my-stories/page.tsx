...
function statusTone(status: StoryStatus): string {
  switch (status) {
    case "published":
    ...
    return (
      <div className="space-y-4 text-center">
        ...
        <p className="text-sm text-zinc-400">
          Submit a story first — we&apos;ll create your session automatically.
        </p>
        <Link
          href="/tell"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        ...
        <Link
          href="/admin/stories"
          className="inline-flex rounded-full border border-white/15 bg-white/5 px-5 py-2.5 text-sm font-semibold text-zinc-300"
        >
          Admin moderation
        </Link>
      </div>
